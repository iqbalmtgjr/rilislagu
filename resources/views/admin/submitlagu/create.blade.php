            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/submit">My Release</a></li>
                        <li class="breadcrumb-item active">Submit Lagu</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('judul_rilisan') is-invalid @enderror"
                                                            name="judul_rilisan" placeholder="Judul Rilisan"
                                                            value="{{ old('judul_rilisan') }}">
                                                        @error('judul_rilisan')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            class="form-control @error('tipe_rilisan') is-invalid @enderror"
                                                            name="tipe_rilisan">
                        ...
                        @enderror
                                                    ...
                                                    <div class="form-group">
                                                        <label for="url_apple_music_artis_utama">URL Apple Music Artis
                                                            Utama</label>
                                                        <input type="text"
                                                            class="form-control @error('url_apple_music_artis_utama') is-invalid @enderror"
                                                            name="url_apple_music_artis_utama"
                                                            placeholder="URL Apple Music Artis Utama"
                                                    ...
                                                    <div class="form-group">
                                                        <label for="url_spotify_artis_featuring">URL Spotify Artis
                                                            Featuring</label>
                                                        <input type="text"
                                                            class="form-control @error('url_spotify_artis_featuring') is-invalid @enderror"
                                                            name="url_spotify_artis_featuring"
                                                            placeholder="URL Spotify Artis Featuring"
                                                    ...
                                                    <div class="form-group">
                                                        <label for="url_apple_music_artis_featuring">URL Apple Music Artis
                                                            Featuring</label>
                                                        <input type="text"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="url_sosial_media"
                                                            placeholder="Bisa URL Instagram/Facebook"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            class="form-control @error('genre_musik') is-invalid @enderror"
                                                            name="genre_musik">
                                                            <option value="">Pilih</option>
                                                            <option value="Blues"
                                                                {{ old('genre_musik') == 'Blues' ? 'selected' : '' }}>Blues
                                                            </option>
                                                            <option value="Musik Anak"
                                                                {{ old('genre_musik') == 'Musik Anak' ? 'selected' : '' }}>
                                                                Musik
                                                                Anak</option>
                                                            <option value="Lagu Kristen"
                                                                {{ old('genre_musik') == 'Lagu Kristen' ? 'selected' : '' }}>
                                                                Lagu
                                                                Kristen
                                                            </option>
                                                            <option value="Klasik"
                                                                {{ old('genre_musik') == 'Klasik' ? 'selected' : '' }}>
                                                                Klasik</option>
                                                            <option value="Komedi"
                                                                {{ old('genre_musik') == 'Komedi' ? 'selected' : '' }}>
                                                                Komedi</option>
                                                            <option value="Country"
                                                                {{ old('genre_musik') == 'Country' ? 'selected' : '' }}>
                                                                Country</option>
                                                            <option value="Easy Listening"
                                                                {{ old('genre_musik') == 'Easy Listening' ? 'selected' : '' }}>
                                                                Easy Listening
                                                            </option>
                                                            <option value="Educational"
                                                                {{ old('genre_musik') == 'Educational' ? 'selected' : '' }}>
                                                                Educational
                                                            </option>
                                                            <option value="Electronik"
                                                                {{ old('genre_musik') == 'Electronik' ? 'selected' : '' }}>
                                                                Electronik</option>
                                                            <option value="Fitnes & Workout"
                                                                {{ old('genre_musik') == 'Fitnes & Workout' ? 'selected' : '' }}>
                                                                Fitnes &
                                                                Workout</option>
                                                            <option value="Folk"
                                                                {{ old('genre_musik') == 'Folk' ? 'selected' : '' }}>Folk
                                                            </option>
                                                            <option value="Hip Hop/Rap"
                                                                {{ old('genre_musik') == 'Hip Hop/Rap' ? 'selected' : '' }}>
                                                                Hip
                                                                Hop/Rap
                                                            </option>
                                                            <option value="Holiday Music"
                                                                {{ old('genre_musik') == 'Holiday Music' ? 'selected' : '' }}>
                                                                Holiday Music
                                                            </option>
                                                            <option value="Inspirasional"
                                                                {{ old('genre_musik') == 'Inspirasional' ? 'selected' : '' }}>
                                                                Inspirasional
                                                            </option>
                                                            <option value="Jazz"
                                                                {{ old('genre_musik') == 'Jazz' ? 'selected' : '' }}>Jazz
                                                            </option>
                                                            <option value="Karaoke"
                                                                {{ old('genre_musik') == 'Karaoke' ? 'selected' : '' }}>
                                                                Karaoke</option>
                                                            <option value="Oldies"
                                                                {{ old('genre_musik') == 'Oldies' ? 'selected' : '' }}>
                                                                Oldies</option>
                                                            <option value="Pop"
                                                                {{ old('genre_musik') == 'Pop' ? 'selected' : '' }}>Pop
                                                            </option>
                                                            <option value="R&B/Soul"
                                                                {{ old('genre_musik') == 'R&B/Soul' ? 'selected' : '' }}>
                                                                R&B/Soul</option>
                                                            <option value="Reggae"
                                                                {{ old('genre_musik') == 'Reggae' ? 'selected' : '' }}>
                                                                Reggae</option>
                                                            <option value="Rock"
                                                                {{ old('genre_musik') == 'Rock' ? 'selected' : '' }}>Rock
                                                            </option>
                                                            <option value="Samba"
                                                                {{ old('genre_musik') == 'Samba' ? 'selected' : '' }}>Samba
                                                            </option>
                                                            <option value="Soundtracks"
                                                                {{ old('genre_musik') == 'Soundtracks' ? 'selected' : '' }}>
                                                                Soundtracks
                                                            </option>
                                                            <option value="Spoken Word"
                                                                {{ old('genre_musik') == 'Spoken Word' ? 'selected' : '' }}>
                                                                Spoken
                                                                Word
                                                            </option>
                                                            <option value="World"
                                                                {{ old('genre_musik') == 'World' ? 'selected' : '' }}>World
                                                            </option>
                                                            <option value="Arabic"
                                                                {{ old('genre_musik') == 'Arabic' ? 'selected' : '' }}>
                                                                Arabic
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('sub_genre') is-invalid @enderror"
                                                            name="sub_genre" placeholder="Sub Genre"
                                                            value="{{ old('sub_genre') }}">
                                                        @error('sub_genre')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            class="form-control @error('lagu_tanpa_vocal') is-invalid @enderror"
                                                            name="lagu_tanpa_vocal">
                                                            <option value="">Pilih Lagu Tanpa Vocal</option>
                                                            <option value="1"
                                                                {{ old('lagu_tanpa_vocal') == '1' ? 'selected' : '' }}>Ya
                                                            </option>
                                                            <option value="0"
                                                                {{ old('lagu_tanpa_vocal') == '0' ? 'selected' : '' }}>
                                                                Tidak
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="bahasa_judul"
                                                            placeholder="Contoh: Indonesia, Inggris, Arab, Daerah"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('nama_label') is-invalid @enderror"
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="nama_pemegang_hak_cipta">Nama Pemegang Hak
                                                            Cipta</label>
                                                        <input type="text"
                                                            class="form-control @error('nama_pemegang_hak_cipta') is-invalid @enderror"
                                                            name="nama_pemegang_hak_cipta"
                                                            placeholder="Boleh diisi nama label"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="upc" placeholder="UPC (jika ada)"
                                                            value="{{ old('upc') }}">
                                                        @error('upc')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            class="form-control @error('konten_dewasa') is-invalid @enderror"
                                                            name="konten_dewasa">
                                                            <option value="">Pilih</option>
                                                            <option value="1"
                                                                {{ old('konten_dewasa') == 1 ? 'selected' : '' }}>Ya
                                                            </option>
                                                            <option value="0"
                                                                {{ old('konten_dewasa') == 0 ? 'selected' : '' }}>Tidak
                                                            </option>
                                                        </select>
                                                        @error('konten_dewasa')
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file"
                                                            class="form-control @error('file_lagu') is-invalid @enderror"
                                                    ...
                                                    <div class="form-group input-group">
                                                        <input type="file"
                                                            class="form-control @error('artwork') is-invalid @enderror"
                                                            name="artwork" placeholder="">
                                                        <div class="input-group-append">
                                                            <button type="button" class="btn btn-info"
                                                                data-toggle="popover" title="Informasi"
                                                                data-content="<ul>
                                              ...
                                              <li>Semua data text harus sesuai dengan metadata yang dimasukkan baik itu ejaan dan cara penulisannya</li>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control @error('detik_mulai') is-invalid @enderror"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            class="form-control @error('saya_adalah') is-invalid @enderror"
                                                            name="saya_adalah">
                                                            <option value="">-- Pilih Opsi --</option>
                                                            <option value="Pihak Solo/Artist"
                                                                {{ old('saya_adalah') == 'Pihak Solo/Artist' ? 'selected' : '' }}>
                                                                Pihak
                                                                Solo/Artist</option>
                                                            <option value="Pihak Band"
                                                                {{ old('saya_adalah') == 'Pihak Band' ? 'selected' : '' }}>
                                                                Pihak
                                                                Band</option>
                                                            <option value="Personil Band"
                                                                {{ old('saya_adalah') == 'Personil Band' ? 'selected' : '' }}>
                                                                Personil Band
                                                            </option>
                                                            <option value="Pihak Management"
                                                                {{ old('saya_adalah') == 'Pihak Management' ? 'selected' : '' }}>
                                                                Pihak
                                                                Management</option>
                                                            <option value="Pihak Label"
                                                                {{ old('saya_adalah') == 'Pihak Label' ? 'selected' : '' }}>
                                                                Pihak
                                                                Label
                                                            </option>
                                                            <option value="Agen"
                                                                {{ old('saya_adalah') == 'Agen' ? 'selected' : '' }}>Agen
                                                            </option>
                                                        </select>
                                                        @error('saya_adalah')
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="url_sosial_media_artis"
                                                            placeholder="URL Sosial Media Artis"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            name="kota_asal" placeholder="Kota Asal"
                                                            value="{{ old('kota_asal') }}">
                                                        @error('kota_asal')
                                                            <div class="invalid-feedback">
                                                                {{ $message }}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file"
                                                            ...
                                                            name="upload_ktp" placeholder="Upload KTP"
